...
from model import NetworkCandidate 
from utils import *
from model_generator import *
...
# Path to data
data_dir = '/home/namnguyen/Desktop/SOCOM_ISIC/demo_code (1)/demo_code/test_image'
batch_size = 64*4
...
def objective_function(ops_hyperopt):
    ...
    child_model = NetworkCandidate(C=32, layers = 8, auxiliary = False, genotype = cell.genotype())
